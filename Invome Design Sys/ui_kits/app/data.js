// Invome app mock data — realistic Nigerian + international names, NGN + USD mix.
window.INVOME_DATA = (() => {
  const clients = [
  ...
  // revenue chart: last 6 months, totaled in NGN-equivalent (USD * 1500 for chart purposes only)
  const revenue = [
  ...
  return { clients, invoices, revenue };
})();
